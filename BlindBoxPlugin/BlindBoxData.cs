    ...
    public class BlindBoxData
    {
        public static readonly Dictionary<ulong, BlindBoxInfo> BlindBoxInfoMap = new()
        {
            ...
            [10077] = new BlindBoxInfo(
                10077,
                [9822, 9826, 9827, 9828, 9834, 9840, 9842, 9848, 9851, 9830, 14208],
                [9828, 9840, 9842, 9848, 9851]
            ),
            // 九宫幻卡铜包
            [10128] = new BlindBoxInfo(
                10128,
                [9775, 9776, 9779, 9782, 9783, 16759, 9795, 9796, 9797, 9798, 16760, 16762, 9809, 15621, 16765],
                [16759, 16760, 16762]
            ),
            // 九宫幻卡银包
            [10129] = new BlindBoxInfo(
                10129,
                [9785, 9786, 9787, 9788, 9790, 9792, 9812, 9814, 9821, 14199, 9827, 9828, 9811, 9813],
                [9788, 9790, 9827, 9828]
            ),
            // 九宫幻卡金包
            [10130] = new BlindBoxInfo(
                10130,
                [9799, 9800, 9801, 9805, 9822, 9829, 9839, 9847, 14192, 9825, 9824, 9826, 9837, 9836, 9838],
                [9839, 9847, 14192]
            ),
            // 九宫幻卡灵银包
