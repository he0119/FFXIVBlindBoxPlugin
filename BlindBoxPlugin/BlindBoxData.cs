...
namespace BlindBoxPlugin
{
    public class BlindBoxInfo
    {
        ...
        public List<string> UniqueItems = new();

        public BlindBoxInfo(ulong itemId, string itemName, List<string> items)
        {
            ItemId = itemId;
            ItemName = itemName;
            Items = items;
        }
        public BlindBoxInfo(ulong itemId, string itemName, List<string> items, List<string> uniqueItems)
        {
            ItemId = itemId;
            ItemName = itemName;
            Items = items;
